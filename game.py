...
Bot2_X, Bot2_Y = random.randint(0, N - 1), random.randint(0,
                                                          N - 1)  # Position of the second bot (Player2): Hackathon
# participants may change it to suitable values to test their codes
...
def score_tab(s, font, SCREEN):
    ...
    text_surface2 = font.render(f"Player 2: " + str(s[1]) + " " + str(" ({:.3f}s)".format(player_clock[1])), True,
                                GREEN)
